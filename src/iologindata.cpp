...
bool IOLoginData::loadPlayerById(Player* player, uint32_t id)
{
	Database& db = Database::getInstance();
	std::ostringstream query;
	query << "SELECT `id`, `name`, `account_id`, `group_id`, `sex`, `vocation`, `experience`, `level`, `maglevel`, `health`, `healthmax`, `blessings`, `mana`, `manamax`, `manaspent`, `soul`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `lookaddons`, `posx`, `posy`, `posz`, `cap`, `lastlogin`, `lastlogout`, `lastip`, `conditions`, `skulltime`, `skull`, `town_id`, `balance`, `offlinetraining_time`, `offlinetraining_skill`, `stamina`, `skill_fist`, `skill_fist_tries`, `skill_club`, `skill_club_tries`, `skill_sword`, `skill_sword_tries`, `skill_axe`, `skill_axe_tries`, `skill_dist`, `skill_dist_tries`, `skill_shielding`, `skill_shielding_tries`, `skill_fishing`, `skill_fishing_tries`, `magic_damage`, `magic_resistance`, `total_mana`, `total_health`, `physical_damage`, `physical_resistance` FROM `players` WHERE `id` = " << id;
...
bool IOLoginData::loadPlayerByName(Player* player, const std::string& name)
{
	Database& db = Database::getInstance();
	std::ostringstream query;
	query << "SELECT `id`, `name`, `account_id`, `group_id`, `sex`, `vocation`, `experience`, `level`, `maglevel`, `health`, `healthmax`, `blessings`, `mana`, `manamax`, `manaspent`, `soul`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `lookaddons`, `posx`, `posy`, `posz`, `cap`, `lastlogin`, `lastlogout`, `lastip`, `conditions`, `skulltime`, `skull`, `town_id`, `balance`, `offlinetraining_time`, `offlinetraining_skill`, `stamina`, `skill_fist`, `skill_fist_tries`, `skill_club`, `skill_club_tries`, `skill_sword`, `skill_sword_tries`, `skill_axe`, `skill_axe_tries`, `skill_dist`, `skill_dist_tries`, `skill_shielding`, `skill_shielding_tries`, `skill_fishing`, `skill_fishing_tries`, `magic_damage`, `magic_resistance`, `total_mana`, `total_health`, `physical_damage`, `physical_resistance` FROM `players` WHERE `name` = " << db.escapeString(name);
	return loadPlayer(player, db.storeQuery(query.str()));
}
...
bool IOLoginData::loadPlayer(Player* player, DBResult_ptr result)
{
	...
	static const std::string bonusNames[] = {"magic_damage", "magic_resistance", "total_mana", "total_health", "physical_damage", "physical_resistance"};
	static const PlayerBonuses_t bonusEnums[] = {BONUS_MAGICDAMAGE, BONUS_MAGICRESISTANCE, BONUS_PHYSICALDAMAGE, BONUS_PHYSICALRESISTANCE, BONUS_TOTALMANA};
	static constexpr size_t bonusSize = sizeof(bonusNames) / sizeof(std::string);
	for (uint8_t i = 0; i < bonusSize; ++i) {
		uint16_t value = result->getNumber<uint16_t>(bonusNames[i]);
		player->setBonus(bonusEnums[i], value);
	}
...
bool IOLoginData::savePlayer(Player* player)
{
	...
	query << "`manamax` = " << player->manaMax - player->manaMaxBonus << ',';
